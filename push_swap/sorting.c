...
/*   Updated: 2023/07/04 18:23:43 by diwalaku      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
// Checks if current > next and if it's not indexed/unassigned.
// If so, current is bigger, so we set it to next since it's value is smaller.
